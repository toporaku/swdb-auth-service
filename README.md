# Servicio de Autenticación y Usuarios (Auth Service) - SWDB 2026

Este repositorio contiene el microservicio de **Servicio de Autenticación y Usuarios (Auth Service)** como un componente independiente del ecosistema SWDB 2026.
...
mvn spring-boot:run
```
*El servicio se desplegará localmente escuchando en el puerto `8082`.*
